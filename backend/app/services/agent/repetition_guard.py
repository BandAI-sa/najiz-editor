...
FIELD_EXAMPLES: dict[str, str] = {
    "تاريخ": "مثل: 2024-01-15 أو 15 يناير 2024",
    "مبلغ": "مثل: 50000 ريال",
    "قيمة": "مثل: 150000 ريال",
    "اسم": "مثل: أحمد بن محمد العلي",
    "رقم": "مثل: 1234567890",
    "هاتف": "مثل: 0551234567",
    "هوية": "مثل: 1012345678",
    "عنوان": "مثل: حي النزهة، شارع الأمير سلطان، الرياض",
    "وقائع": "مثل: استأجرت الشقة بتاريخ كذا وما سدد الإيجار",
    "طلبات": "مثل: أطلب إلزامه بدفع المبلغ المستحق",
    "أسانيد": "مثل: عقد إيجار، رسائل واتساب، صور، شهود",
    "مستند": "مثل: عقد، فاتورة، إيصال، خطاب رسمي",
    "موضوع": "مثل: مطالبة مالية بسبب عدم سداد إيجار",
    "بريد": "مثل: example@email.com",
    "جوال": "مثل: 0551234567",
    "وكالة": "مثل: وكالة رقم 12345 صادرة من كتابة عدل الرياض",
    "وكيل": "مثل: اسم الوكيل وصفته ورقم رخصته",
    "تقدير": "مثل: 100,000 ريال (تقدير أولي)",
}
        ...
        *,
        ...
        if action == RepetitionAction.OFFER_SKIP:
            return (
                ...
                f"هالحقل يحسّن جودة الصحيفة لكنه غير مانع للمتابعة.\n"
